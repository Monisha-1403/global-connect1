    ...
    <div className="bg-white rounded-lg shadow-md p-6 mb-4 border border-gray-200">
      ...
      {isSearchResult && (
        <div className="flex gap-4 mt-2">
          <Button onClick={handleApply} className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded">
            Apply Now
          </Button>
          <Button onClick={handleBack} className="bg-gray-300 hover:bg-gray-400 text-gray-800 py-2 px-4 rounded">
            Back to Jobs
          </Button>
        </div>
      )}
